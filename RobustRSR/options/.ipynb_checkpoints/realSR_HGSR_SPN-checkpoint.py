...
#     parser.add_argument('--dataroot', type=str, default='/home/lhn/Datasets/RealSR_TrainPatch/X4')
#     parser.add_argument('--test_dataroot', type=str, default='/home/lhn/Datasets/RealSR_TrainPatch/X4/Vali100_rand36')
    ...
    ## Train Settings
    parser.add_argument('--exp_name', type=str, default='HGMHInt-HG2CSPN-JTrain-2', help='')
#     parser.add_argument('--exp_name', type=str, default='HGMHInt-HG6CSPN', help='')
    parser.add_argument('--sr_LR', type=float, default=2e-5, help='learning rate for SR generator')
    parser.add_argument('--sr_decay_step', type=list, default=[8e4], help='')
    ...
    ## SPN Settings
    parser.add_argument('--spn_model', type=str, default='CSPN', help='[SPN | CSPN]')
    parser.add_argument('--train_SR', type=bool, default=True, help='residual scaling')
    parser.add_argument('--spn_LR', type=float, default=1e-2, help='learning rate for SR generator')
    parser.add_argument('--spn_momentum', type=float, default=0.9, help='learning rate for SR generator')
    parser.add_argument('--spn_weight_decay', type=float, default=1e-4, help='learning rate for SR generator')
    parser.add_argument('--pretrain', type=str, default='')
#     parser.add_argument('--decay_step', type=list, default=[2e4, 4e4, 6e4], help='')
    parser.add_argument('--decay_step', type=list, default=[8e4], help='')
    parser.add_argument('--spn_HG', type=int, default=2, help='')
    parser.add_argument('--lr_decay', type=float, default=0.5, help='learning rate for SR generator')
    ...
    parser.add_argument('--inte_loss_weight', type=list, default=[1, 1, 1], help='residual scaling')
