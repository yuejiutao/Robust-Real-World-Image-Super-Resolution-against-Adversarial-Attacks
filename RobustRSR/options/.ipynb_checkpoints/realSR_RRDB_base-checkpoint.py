...
def parse_config(local_test=True):
    ...
    ## Train Settings
    parser.add_argument('--exp_name', type=str, default='realSR_RRDB_Ploss_RefH', help='')
    ...
    ## SRModel Settings
    parser.add_argument('--pretrain', type=str, default='./models/RRDB_RSRPtrain_Feat_PSNR_X4_0.pth')
    parser.add_argument('--model', type=str, default='RRDB-Fea', help='[RRDB | srresnet | EDSR | RCAN | RRDB-Fea | HGSR-MHR | HGSR]')
    ...
    parser.add_argument('--sr_lambda', type=float, default=1e-2, help='content loss lambda')
    ...
    parser.add_argument('--post_loss', type=bool, default=True, help='')
